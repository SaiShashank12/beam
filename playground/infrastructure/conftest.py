...
def create_test_example(create_test_tag):
    ...
    def _create_test_example(is_multifile=False,
                             with_kafka=False,
        ...
        return Example(
            tag=create_test_tag(is_multifile=is_multifile,
...
def create_test_tag():
    ...
    def _create_test_tag(with_kafka=False,
                         kafka_datasets=None,
                         is_multifile=False,
                         context_line=30,
                         line_start=10,
        ...
        if with_kafka:
            ...
            meta.update(emulators=emulators, datasets=kafka_datasets)
        if is_multifile:
            meta.update(multifile=True,
                        files=[{
                            "name": "utils.java"
                        }, {
                            "name": "schema.java"
