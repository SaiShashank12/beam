...
class Dataset(_message.Message):
    ...
    def __init__(self,
                 type: _Optional[_Union[EmulatorType, str]] = ...,
                 options: _Optional[_Mapping[str, str]] = ...,
                 dataset_path: _Optional[str] = ...) -> None:
        ...
...
class RunCodeRequest(_message.Message):
    ...
    def __init__(
        self,
        code: _Optional[str] = ...,
        sdk: _Optional[_Union[Sdk, str]] = ...,
        pipeline_options: _Optional[str] = ...,
        datasets: _Optional[_Iterable[_Union[Dataset, _Mapping]]] = ...,
        files: _Optional[_Iterable[_Union[SnippetFile,
                                          _Mapping]]] = ...) -> None:
        ...
...
class PrecompiledObject(_message.Message):
    __slots__ = [
        "cloud_path", "name", "description", "type", "pipeline_options",
        "link", "multifile", "context_line", "default_example", "sdk",
        "complexity", "tags", "datasets", "url_vcs", "url_notebook",
        "always_run", "never_run"
    ]
    ...
    def __init__(self,
                 cloud_path: _Optional[str] = ...,
                 name: _Optional[str] = ...,
                 description: _Optional[str] = ...,
                 type: _Optional[_Union[PrecompiledObjectType, str]] = ...,
                 pipeline_options: _Optional[str] = ...,
                 link: _Optional[str] = ...,
                 multifile: bool = ...,
                 context_line: _Optional[int] = ...,
                 default_example: bool = ...,
                 sdk: _Optional[_Union[Sdk, str]] = ...,
                 complexity: _Optional[_Union[Complexity, str]] = ...,
                 tags: _Optional[_Iterable[str]] = ...,
                 datasets: _Optional[_Iterable[_Union[Dataset,
                                                      _Mapping]]] = ...,
                 url_vcs: _Optional[str] = ...,
                 url_notebook: _Optional[str] = ...,
                 always_run: bool = ...,
                 never_run: bool = ...) -> None:
        ...
...
class Categories(_message.Message):
    ...
    class Category(_message.Message):
        ...
        category_name: str
        precompiled_objects: _containers.RepeatedCompositeFieldContainer[
            PrecompiledObject]

        def __init__(
            self,
            category_name: _Optional[str] = ...,
            precompiled_objects: _Optional[_Iterable[_Union[PrecompiledObject,
                                                            _Mapping]]] = ...
        ) -> None:
            ...
    ...
    sdk: Sdk
    categories: _containers.RepeatedCompositeFieldContainer[
        Categories.Category]

    def __init__(
        self,
        sdk: _Optional[_Union[Sdk, str]] = ...,
        categories: _Optional[_Iterable[_Union[Categories.Category,
                                               _Mapping]]] = ...
    ) -> None:
        ...
...
class GetPrecompiledObjectsResponse(_message.Message):
    ...
    def __init__(
        self,
        sdk_categories: _Optional[_Iterable[_Union[Categories,
                                                   _Mapping]]] = ...
    ) -> None:
        ...
...
class GetPrecompiledObjectResponse(_message.Message):
    ...
    def __init__(
        self,
        precompiled_object: _Optional[_Union[PrecompiledObject,
                                             _Mapping]] = ...
    ) -> None:
        ...
...
class SaveSnippetRequest(_message.Message):
    __slots__ = [
        "files", "sdk", "pipeline_options", "complexity", "persistence_key"
    ]
    FILES_FIELD_NUMBER: _ClassVar[int]
    SDK_FIELD_NUMBER: _ClassVar[int]
    PIPELINE_OPTIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self,
                 ...
                 pipeline_options: _Optional[str] = ...,
                 complexity: _Optional[_Union[Complexity, str]] = ...,
                 persistence_key: _Optional[str] = ...) -> None:
        ...
...
class GetSnippetResponse(_message.Message):
    ...
    def __init__(self,
                 ...
                 sdk: _Optional[_Union[Sdk, str]] = ...,
                 pipeline_options: _Optional[str] = ...,
                 complexity: _Optional[_Union[Complexity, str]] = ...) -> None:
        ...
...
class GetMetadataResponse(_message.Message):
    __slots__ = [
        "runner_sdk", "build_commit_hash",
        "build_commit_timestamp_seconds_since_epoch", "beam_sdk_version"
    ]
    ...
    def __init__(
            self,
            runner_sdk: _Optional[str] = ...,
            build_commit_hash: _Optional[str] = ...,
            build_commit_timestamp_seconds_since_epoch: _Optional[int] = ...,
            beam_sdk_version: _Optional[str] = ...) -> None:
        ...
